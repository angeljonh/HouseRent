            ...
            <div class="card-overlay">
              <div class="card-header-b">
                ...
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">La casa se acerca
                      <br> ahora</a>
                  </h2>
                </div>
                <div class="card-date">
                  <span class="date-b">7 Oct. 2019</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-box-b card-shadow news-box">
            ...
            <div class="card-overlay">
              <div class="card-header-b">
                ...
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">El viaje está llegando
                      <br> ahora</a>
                  </h2>
                </div>
                <div class="card-date">
          ...
          <div class="card-box-b card-shadow news-box">
            ...
            <div class="card-overlay">
              <div class="card-header-b">
                ...
                <div class="card-title-b">
                  <h2 class="title-2">
                    <a href="blog-single.html">El parque se acerca
                      <br> ahora</a>
                  </h2>
                </div>
                <div class="card-date">
