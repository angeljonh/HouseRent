    ...
    <div class="row justify-content-center">
        <div class="col-md-16">
            <div class="card">
                ...
                <div class="card-body">
                  <a href="{{ route('propiedad.index') }}" class="btn btn-default btn-sm">Listado de propiedades</a>
                    <table class="table">
                    <thead>
                        <tr><th>ID</th> <th>Domicilio</th> <th>Numero</th> <th>Zona</th><th>Codigo postal</th> <th>Precio</th><th>Area</th> <th>Camas</th><th>Cuartos</th> <th>Baños</th><th>Accion</th></tr>
                      </thead>
                      <tbody>
                          <tr>
                            <td>{{ $propiedad->id }}</td>
