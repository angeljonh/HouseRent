    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('propiedad.index') }}">CRUD</a>
          </li>
        </ul>
      </div>
                ...
                <div class="card-body">
                    ...
                    @endif
                      ...
                      <div class="form-group">
                        ...
                        {!! Form::text('numero', null, ['class' => $errors->has('numero') ? 'form-control is-invalid' : 'form-control']) !!}
                      </div>
                      <div class="form-group">
                        {!! Form::label('zona', 'zona') !!}
                        {!! Form::select('zona',  $zonas ?? '', null, ['class' => 'form-control']) !!}
                        
                      </div>
                      <div class="form-group">
                        {!! Form::label('cp', 'cp') !!}
                        {!! Form::text('cp', null, ['class' => $errors->has('cp') ? 'form-control is-invalid' : 'form-control']) !!}
                      </div>
                      <div class="form-group">
                        {!! Form::label('precio', 'precio') !!}
                        {!! Form::text('precio', null, ['class' => $errors->has('precio') ? 'form-control is-invalid' : 'form-control']) !!}
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        {!! Form::text('camas', null, ['class' => $errors->has('camas') ? 'form-control is-invalid' : 'form-control']) !!}
                      </div>
                      <div class="form-group">
                        {!! Form::label('cuartos', 'cuartos') !!}
                        {!! Form::text('cuartos', null, ['class' => $errors->has('cuartos') ? 'form-control is-invalid' : 'form-control']) !!}
                      </div>
                      <div class="form-group">
                        {!! Form::label('baños', 'baños') !!}
                        {!! Form::text('baños', null, ['class' => $errors->has('baños') ? 'form-control is-invalid' : 'form-control']) !!}
                      </div>
            ...
            <div class="w-body-a">
              <div class="w-body-a">
                <ul class="list-unstyled">
                  ...
                  <li class="item-list-a">
                    <i class="fa fa-angle-right"></i> <a href="#">Administrador de agente</a>
                  </li>
                  <li class="item-list-a">
                    <i class="fa fa-angle-right"></i> <a href="#">Carreras</a>
                  </li>
                  <li class="item-list-a">
                    <i class="fa fa-angle-right"></i> <a href="#">Afiliado</a>
                  </li>
                  <li class="item-list-a">
                    <i class="fa fa-angle-right"></i> <a href="#">Política de privacidad</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="col-sm-12 col-md-4 section-md-t3">
          <div class="widget-a">
            ...
            <div class="w-body-a">
              <ul class="list-unstyled">
                <li class="item-list-a">
                  <i class="fa fa-angle-right"></i> <a href="#">Mexico</a>
                </li>
              </ul>
            </div>
          </div>
