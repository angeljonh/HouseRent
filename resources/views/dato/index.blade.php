...
@section('content')
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('dato.index') }}">CRUD</a>
          </li>
        </ul>
      </div>
 ...
 <div class="col-md-12">
  <br />
  <h3 align="center">Datos de propiedades</h3>
  <br />
  ...
  @endif
  <div align="right">
   <a href="{{route('dato.create')}}" class="btn btn-primary">Agregar</a>
   <br />
   <br />
  </div>
  <table class="table table-bordered table-striped">
   ...
   <tr>
    ...
    <td>{{$row['cuartos']}}</td>
    <td>{{$row['baños']}}</td>
    <td><a href="{{action('DatoController@edit', $row['id'])}}" class="btn btn-warning">Editar</a></td>
    <td>
     <form method="post" class="delete_form" action="{{action('DatoController@destroy', $row['id'])}}">
      {{csrf_field()}}
